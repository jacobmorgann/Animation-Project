...
for (i=0; i<10; i++) {
    num1 = Math.floor(Math.random() * 150) 
}
const characterRandom = {
    arrImgs3: ["trunningw0000.png", "trunningw0001.png", "trunningw0002.png", "trunningw0003.png", "trunningw0004.png", "trunningw0005.png", "trunningw0006.png", 
    "trunningw0007.png", "trunningw0008.png", "trunningw0009.png", "trunningw0010.png", "trunningw0011.png"],
   poseNumber: 0,
   ...
   screenHeight: document.querySelector("#christmas").scrollHeight,
   x: 0,
   y:document.querySelector("#christmas").scrollHeight - num1,
   timerId: null
}
function myMove3 () {
...
function myFrame3 () {
   if (characterRandom.x < 150){
       characterRandom.x = characterRandom.screenWidth / 2 - 75;
   } else {
       characterRandom.x -= 5;
       ...
       characterRandom.poseNumber = (characterRandom.poseNumber + 1) % 8;
   }
}
